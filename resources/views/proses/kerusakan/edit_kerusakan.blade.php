    ...
    <div class="col-md-6 mt-4">
        <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
                <form method="POST" action="{{route('update_kerusakan',$id)}}">
                    @csrf
                    <div class="form-group mb-50 col-md-6">
                        ...
                        <input type="text" class="form-control datetimepicker-input ukuran_font" data-target="#reservationdate" id="tgl_kerusakan" name="tgl_kerusakan" datetimepicker="Y-m-d" value="{{$kerusakan->tgl_kerusakan}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <option value="{{$kerusakan->id_pelaksana}}">{{$kerusakan->nama_pelaksana}}</option>
                    ...
                    <input type="text" style="" class="form-control ukuran_font" id="komponen" name="komponen" value="{{$kerusakan->komponen}}">
                        <span class="text-danger">{{$errors->first('komponen')}}</span>
                    </div>

                    <div class="form-group">
                        <label for="email" style="font-size: 15px;" class="ukuran_font">Keterangan</label>
                    <textarea name="detail_kerusakan" class="form-control" id="detail_kerusakan" cols="30" rows="5" aria-valuemax="{{$kerusakan->detail_kerusakan}}">{{$kerusakan->detail_kerusakan}}</textarea> 
                    </div> 
                    <hr> 
                    <div class="row">
                        <div class="col-md-4">
