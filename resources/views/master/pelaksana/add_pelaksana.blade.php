    ...
    <div class="col-md-6 mt-4">
        <div class="card card-outline card-info">
            <div class="card-header">
                <h5> Form Tambah Pelaksana </h5> 
            </div> 
            <div class="card-body pad">  
                <form method="POST" action="{{route('save_pelaksana')}}">
                    @csrf
                     <div class="form-group">
                        <label class="ukuran_font" for="nama_pelaksana">Nama Pelaksana</label>
                        <input type="text" class="form-control ukuran_font"  name="nama_pelaksana" id="nama_pelaksana">
