    ...
    <div class="col-md-6 mt-4">
        <div class="card card-outline card-info">
            <div class="card-header">
                <h5> Form Edit Sistem </h5> 
            </div> 
            <div class="card-body pad"> 
                <form method="POST" action="{{route('update_sistem',$sistem->id)}}">
                    @csrf
                    <div class="form-group">
                        <label class="ukuran_font" for="kode_komponen_sistem">Kode Sistem</label>
                        <input type="text" class="form-control ukuran_font" value="{{$sistem->kode_komponen_sistem}}" name="kode_komponen_sistem" id="kode_komponen_sistem">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ukuran_font" value="{{$sistem->nama_komponen_sistem}}"  name="nama_komponen_sistem" id="nama_komponen_sistem">
                        <span class="text-danger">{{$errors->first('nama_komponen_sistem')}}</span>
                    </div>

                    <div class="form-group">
                        <label class="ukuran_font" for="email">Keterangan</label>
                        <textarea class="form-control ukuran_font" id="keterangan" name="keterangan" value="{{$sistem->keterangan}}">{{$sistem->keterangan}}</textarea>
                    </div>  
