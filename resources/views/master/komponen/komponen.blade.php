                ...
                <div class="pencarian_data">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin-top: 16px">
                            <a class="btn btn-block bg-gradient-info btn-sm float-right mt-4" style="width: 150px;" href="{{route('create_komponen')}}"><i class="fa fa-plus"></i> Add Komponen</a>
                        </div>
                    </div> 
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ukuran_font" style="padding-top:5px; padding-left:5px; padding-right:5px; padding-bottom:5px; font-size: 14px; width: 100px">
                                            <div class="row">
                                                ...
                                                <div class="col-sm">
                                                    <a class="btn btn-block bg-gradient-danger btn-sm delete_komponen" title="Delete" href="#" data-set="delete_komponen" data-id="{{$datas->id}}"><i class="fa fa-cut"></i> </a>
                                                </div>
                                            </div> 
                                        </td>  
                                    </tr>
...
<div class="modal fade text-left" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel19" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('delete_komponen')}}" method="POST">
            @csrf
            <div class="modal-body">
                Apakah anda ingin menghapus data komponen ?
...
<script type="text/javascript">
    ...
    $("#pencarian").keyup(function(){ 
        $.ajax({
            ...
            type     : "POST",
            url      : "{{route('pencarian_komponen_master')}}",
            cache    : false,
            datetype : "JSON", 
            data:{
