    ...
    <div class="col-md-6 mt-4">
        <div class="card card-outline card-info">
            <div class="card-header">
                <h5> Form Tambah Sub-Sistem </h5> 
            </div> 
            <div class="card-body pad">
                <form method="POST" action="{{route('save_subsistem')}}">
                    @csrf  
                    <div class="form-group">
                        <label class="ukuran_font" for="kode_komponen_sub_sistem">Kode Sub-Sistem</label>
                        <input type="text" class="form-control ukuran_font"  name="kode_komponen_sub_sistem" id="kode_komponen_sub_sistem">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ukuran_font"  name="nama_komponen_sub_sistem" id="nama_komponen_sub_sistem">
