                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="pencarian" id="pencarian" class="form-control ukuran_font" placeholder="Sub-kelompok ...">
                            </div>
                        </div>
                        <div class="col-md-6" style="margin-top: 16px">
                            <a class="btn btn-block bg-gradient-info btn-sm float-right mt-4" style="width: 200px;" href="{{route('create_subkelompok')}}"><i class="fa fa-plus"></i> Tambah SubKelompok</a>
                        </div>
                    </div> 
                </div>
                            ...
                            @if ($data_subkelompok->count())
                                @foreach ($data_subkelompok as $datas)
                                    <tr>
                                        ...
                                        <td class="ukuran_font" style="padding-top:5px; padding-left:5px; padding-right:5px; padding-bottom:5px; font-size: 14px">{{$datas->kode_sub_pokok}}</td>  
                                        <td class="ukuran_font" style="padding-top:5px; padding-left:5px; padding-right:5px; padding-bottom:5px; font-size: 14px">{{$datas->nama_sub_pokok}}</td>  
...
<div class="modal fade text-left" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel19" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('delete_subkelompok')}}" method="POST">
            @csrf
            <div class="modal-body">
                Apakah anda ingin menghapus data sub-kelompok komponen ?
...
<script type="text/javascript">
   ...
   $("#pencarian").keyup(function(){ 
        $.ajax({
            ...
            type     : "POST",
            url      : "{{route('pencarian_subkelompok_master')}}",
            cache    : false,
            datetype : "JSON", 
            data:{
